window.addEventListener('load', function () {
  ...
  for (var i = 0; i < cut.length; i++) {
    ...
    cut[i].onmouseenter = function () {
      ...
      img1.src = '../images/c-brand2-' + this.index + '.jpg'
      dtp.src = '../images/c-brand2-b' + this.index + '.jpg'
  ...
  pol.onclick = function () {
    ...
    img1.src = '../images/c-brand2-2.jpg'
    dtp.src = '../images/c-brand2-b2.jpg'
  }
  por.onclick = function () {
    this.classList.add('currentColor')
    pol.classList.remove('currentColor')
    img1.src = '../images/c-brand2-1.jpg'
    dtp.src = '../images/c-brand2-b1.jpg'
  }
