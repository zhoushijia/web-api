window.addEventListener('load', function () {
  ...
  for (var i = 0; i < cut.length; i++) {
    ...
    cut[i].onmouseenter = function () {
      ...
      img1.src = '../images/c-brand6-' + this.index + '.jpg'
      dtp.src = '../images/c-brand6-b' + this.index + '.jpg'
  ...
  pol.onclick = function () {
    ...
    img1.src = '../images/c-brand6-2.jpg'
    dtp.src = '../images/c-brand6-b2.jpg'
  }
  por.onclick = function () {
    this.classList.add('currentColor')
    pol.classList.remove('currentColor')
    img1.src = '../images/c-brand6-1.jpg'
    dtp.src = '../images/c-brand6-b1.jpg'
  }
