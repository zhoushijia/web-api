window.addEventListener('load', function () {
  ...
  for (var i = 0; i < cut.length; i++) {
    ...
    cut[i].onmouseenter = function () {
      ...
      img1.src = '../images/c-brand3-' + this.index + '.jpg'
      dtp.src = '../images/c-brand3-b' + this.index + '.jpg'
      // console.log(img1, boxn)
    }
  }
  ...
  pol.onclick = function () {
    ...
    img1.src = '../images/c-brand3-4.jpg'
    dtp.src = '../images/c-brand3-b4.jpg'
  }
  por.onclick = function () {
    this.classList.add('currentColor')
    pol.classList.remove('currentColor')
    img1.src = '../images/c-brand3-2.jpg'
    dtp.src = '../images/c-brand3-b2.jpg'
  }
